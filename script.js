...
/* 
finoAQuando (dellaBombsList.laLunghezza èMinoreDelle totalBombs) eseguiQuestaOperazione{
  costante number = arrotondato(numero.random(cheSaràDaZeroAZero,99999) moltiplicaloPer totalCellsCheSono100) + 1 perchéAltrimentiDa1a99;
  se (bombsListNON!.include(questoNumero)) allora{
    nellabombsList.pusha(ilNumero);
  }
}
...
for (let i = 1; i <= totalCells; i++) {
	...
	cell.addEventListener("click", function () {
		// Controllo che la cella non sia stata già cliccata -> se return da solo INTERROMPE la funzione
...
function updateScore() {
	...
	// Controlliammo se l'utente ha vinto
...
function endGame(isVictory) {
	...
	// Mostriamo la schermata rimuovendo la classe hidden
...
EVENTI
-----------------*/
// Gestiamo il click sul tasto Gioca di nuovo
